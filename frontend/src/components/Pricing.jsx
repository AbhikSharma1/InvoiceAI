...
const PricingCard = ({
    ...
    <div className={`${pricingCardStyles.card} ${isPopular ? pricingCardStyles.cardPopular : pricingCardStyles.cardRegular
            ...
            <div className={pricingStyles.container}>
                <div className={pricingStyles.headerContainer}>
                    ...
                    <div style={{ marginTop: 12 }} className={pricingStyles.billingToggle}>
                        <button onClick={() => setBillingPeriod('monthly')} className={`${pricingStyles.billingButton} ${billingPeriod === 'monthly' ? pricingStyles.billingButtonActive : ''
                            }`}>
                            Monthly
                        </button>
                        <button onClick={() => setBillingPeriod('annual')} className={`${pricingStyles.billingButton} ${billingPeriod === 'annual' ? pricingStyles.billingButtonActive : ''
                            }`}>
                            Annually

                            <span className={pricingStyles.billingBadge}>Save 20% off</span>
                        </button>
                    </div>
                </div>
                ...
                <div className={pricingStyles.additionalInfo}>
                    ...
                    <div className={pricingStyles.faqCta}>
                        <p className={pricingStyles.faqText}>
                            Have a questions about pricing ? {" "}
