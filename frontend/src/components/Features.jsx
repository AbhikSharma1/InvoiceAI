            ...
            <div className={featuresStyles.container}>
                <div className={featuresStyles.headerContainer}>
                    ...
                    <p className={featuresStyles.subtitle}>
                        A minimal, intelligent interface that focuses on what truely matters -
                        Create, Send and Track Invoices effortlessly while maintaining a professional excellence.
                    </p>
