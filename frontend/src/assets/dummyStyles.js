...
export const featuresStyles = {
  ...
  // Feature Card
  featureCard: "group relative bg-white/80 backdrop-blur-sm rounded-2xl p-8 px-6 border border-white/60 shadow-sm hover:shadow-2xl transition-all duration-500 ease-out hover:-translate-y-2 overflow-hidden",
...
export const navbarStyles = {
  ...
  signUpText: "relative text-white",
